...
import { ApiResponseModel, bl_fi_generic_doc_hdr_RowClass, InternalJobsheetService, InternalOutboundDeliveryOrderService, Pagination, SubQueryService } from 'blg-akaun-ts-lib';
...
@Component({
  selector: 'app-ko-by-delivery-order-item',
  templateUrl: './ko-by-delivery-order-item.component.html',
  styleUrls: ['./ko-by-delivery-order-item.component.css']
})
export class KoByDeliveryOrderItemComponent implements OnInit, OnDestroy {
  ...
  columnsDefs = [
    { headerName: 'Delivery Order No.', field: 'doc_number', cellStyle: () => ({ 'text-align': 'left' }), maxWidth: 100 },
