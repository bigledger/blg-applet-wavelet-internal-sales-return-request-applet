...
import {
  ...
  MyEInvoiceBatchPoolDocHdrService
...
@Component({
  selector: "app-pending-in-batch-queue",
  templateUrl: "./pending-in-batch-queue.component.html",
  styleUrls: ["./pending-in-batch-queue.component.scss"],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [ComponentStore],
})
export class PendingInBatchQueueComponent extends ViewColumnComponent {
  protected subs = new SubSink();

  protected compName = "Pending In Batch Queue";
  ...
  columnsDefs = [
    {
      ...
      field: "bl_fi_my_einvoice_batch_pool_doc_hdr.validation_error",
  ...
  setGridData() {
    ...
    const datasource = {
      getRows: (grid) => {
        ...
        this.subs.sink = this.myEInvoiceBatchPoolDocHdrService
