...
@Component({
  selector: "app-helper-checking-listing-all",
  templateUrl: "./helper-checking-listing-all.component.html",
  styleUrls: ["./helper-checking-listing-all.component.css"],
})
export class HelperCheckingListingAllComponent extends ViewColumnComponent {
  protected compName = "Helper Checking Listing All";
  ...
  onGridReady(params) {
    ...
    this.store
      ...
      .subscribe((data) => {
        this.fileGuid = data;
        this.store.dispatch(FileImportActions.loadFileImportAllData({ fileImportHdrGuid: this.fileGuid }));
      }
    );
    this.store.select(FileImportSelectors.selectFileImportAllData).subscribe((data) => {
      if (data) {
        this.rowData = data;
