...
import { SalesReturnFileExportPagesService } from '../../services/sales-return-file-export.service';
...
@Component({
  ...
  providers: [SalesReturnFileExportPagesService]

})
export class SalesReturnFileExportContainerComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private pagesService: SalesReturnFileExportPagesService,
  ...
  ngOnInit() {
    ...
    this.subSink.sink = this.viewColFacade.salesReturnFileExportCache$.subscribe(a =>
  ...
  ngOnDestroy() {
    this.viewColFacade.saveFileExportState();
