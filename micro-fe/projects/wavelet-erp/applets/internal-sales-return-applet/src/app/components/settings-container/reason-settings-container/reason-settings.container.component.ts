...
import { ReasonSettingsPagesService } from '../../../services/reason-settings-pages.service';

@Component({
  template: containerTemplate,
  animations: containerAnim,
  providers: [ReasonSettingsPagesService]

})
export class ReasonSettingsContainerComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private pagesService: ReasonSettingsPagesService,
  ...
  ngOnInit() {
    ...
    this.subSink.sink = this.viewColFacade.reasonSettingsViewCache$.subscribe(a =>
  ...
  ngOnDestroy() {
    this.viewColFacade.saveReasonSettingsState();
