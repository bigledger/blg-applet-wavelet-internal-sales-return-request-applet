...
import { PrintableFormatSettingsPagesService } from '../../../services/printable-format-settings-pages.service';

@Component({
  template: containerTemplate,
  animations: containerAnim,
  providers: [PrintableFormatSettingsPagesService]

})
export class PrintableFormatSettingsContainerComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private pagesService: PrintableFormatSettingsPagesService,
  ...
  ngOnInit() {
    ...
    this.subSink.sink = this.viewColFacade.printableFormatSettingsCache$.subscribe(a =>
  ...
  ngOnDestroy() {
    this.viewColFacade.savePrintableFormatSettingsState();
