...
import { Pagination, InternalSalesQuotationService, SubQueryService, ApiResponseModel, bl_fi_generic_doc_line_RowClass, bl_fi_generic_doc_link_RowClass } from 'blg-akaun-ts-lib';
import { AppConfig } from 'projects/shared-utilities/visa';
import { SubSink } from 'subsink2';
import { salesQuotationLineItemSearchModel } from '../../../../../../models/advanced-search-models/line-item.model';
...
import { AppletConstants } from 'projects/wavelet-erp/applets/internal-sales-return-applet/src/app/models/constants/applet-constants';
...
import { LinkActions, PNSActions } from 'projects/wavelet-erp/applets/internal-sales-return-applet/src/app/state-controllers/draft-controller/store/actions';

@Component({
  selector: 'app-copy-quotation-item',
  templateUrl: './copy-quotation-item.component.html',
  styleUrls: ['./copy-quotation-item.component.css']
})
export class CopyQuotationItemComponent implements OnInit, OnDestroy {
  ...
  gridApi;
  searchModel = salesQuotationLineItemSearchModel;
  ...
  columnsDefs = [
    { headerName: 'Sales Quotation No.', field: 'doc_number', cellStyle: () => ({ 'text-align': 'left' }), maxWidth: 100, checkboxSelection: true, floatingFilter: true },
    ...
    { headerName: 'Sales Quotation Qty', field: 'order_qty', type: 'numericColumn', floatingFilter: true },
  ...
  constructor(
    private isqService: InternalSalesQuotationService,
  ...
  setGridData(criteria?: any) {
    ...
    const datasource = {
      getRows: grid => {
        ...
        this.subs.sink = this.isqService.getGenericDocumentHdrLineByCriteria(
          pagination,
          apiVisa).subscribe(
            (res) => {
