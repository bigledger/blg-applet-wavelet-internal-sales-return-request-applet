...
@Component({
  selector: 'app-sales-return-select-billing-address',
  templateUrl: './select-billing-address-listing.component.html',
  styleUrls: ['./select-billing-address-listing.component.scss'],
...
export class SelectBillingAddressComponent extends ViewColumnComponent {
  ...
  onRowClicked(billing_address) {
    this.store.dispatch(SalesReturnActions.selectBillingAddress({ billing_address }));
  }
