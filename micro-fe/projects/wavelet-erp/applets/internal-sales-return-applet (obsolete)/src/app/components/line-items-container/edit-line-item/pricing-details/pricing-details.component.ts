...
@Component({
  selector: 'app-edit-line-item-pricing-details',
  templateUrl: './pricing-details.component.html',
  styleUrls: ['./pricing-details.component.scss']
})
export class EditLineItemPricingDetailsComponent implements OnInit {
  ...
  // rowData = [
  //   { schema_code: "PRICE_001", schema_name: "Retail Price", unit_price: 2599.00, mod_date: "02-05-2021" }
  // ];
