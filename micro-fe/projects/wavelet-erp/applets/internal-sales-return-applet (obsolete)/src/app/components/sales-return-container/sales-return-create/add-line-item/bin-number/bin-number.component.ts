...
import { SalesReturnSelectors, ItemSelectors } from '../../../../../state-controllers/sales-return-controller/store/selectors';
import { SalesReturnStates } from '../../../../../state-controllers/sales-return-controller/store/states';

@Component({
  selector: 'app-line-item-bin-number',
  templateUrl: './bin-number.component.html',
  styleUrls: ['./bin-number.component.css']
})
export class LineItemBinNumberComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.store.select(ItemSelectors.selectBin).subscribe({
