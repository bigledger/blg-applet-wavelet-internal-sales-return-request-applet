...
export class GenericContainerComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private pagesService: GenericPagesService) {
  }

  ngOnInit() {
    this.subs.sink = this.viewColFacade.genericCache$.subscribe(a =>
  ...
  ngOnDestroy() {
    ...
    this.viewColFacade.saveGenericState();
  }
