...
@Component({
  selector: 'app-internal-sales-proforma-invoice-add-settlement',
  templateUrl: './internal-sales-proforma-invoice-add-settlement.component.html',
  styleUrls: ['./internal-sales-proforma-invoice-add-settlement.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [ComponentStore, DatePipe]
})
export class InternalSalesProformaInvoiceAddSettlementComponent extends ViewColumnComponent {

  protected subs = new SubSink();

  protected compName = 'Add Settlement';
  protected index = 8;
  ...
  onSettlementTypeChange(e: SettlementMethodContainerModel) {
    ...
    console.log(this.currSettlementType);
    switch (this.currSettlementType) {
      case 'CASH':
        this.invalid = false;
        this.form = new FormGroup({
