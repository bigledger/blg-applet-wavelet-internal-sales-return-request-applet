...
ng build --prod --project=internal-shopping-cart-applet --output-hashing none
...
aws s3 mv s3://akaun-applets/bigledger/wavelet-erp/internal-shopping-cart-applet/prod s3://akaun-applets/bigledger/wavelet-erp/internal-shopping-cart-applet/prod/backups/Backup-`date +%Y-%m-%d:%H:%M:%S` --profile akaun --recursive --exclude "backups/*"

# WARNING: Upload the new  file to s3
aws s3 cp elements/wavelet-erp/applets/internal-shopping-cart-applet/ s3://akaun-applets/bigledger/wavelet-erp/internal-shopping-cart-applet/prod --profile akaun --acl public-read --recursive
...
aws s3 cp /tmp/changelog.txt s3://akaun-applets/bigledger/wavelet-erp/internal-shopping-cart-applet/prod/changelog.txt --profile akaun --acl bucket-owner-full-control
