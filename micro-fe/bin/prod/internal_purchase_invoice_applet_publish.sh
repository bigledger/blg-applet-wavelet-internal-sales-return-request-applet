...
aws s3 cp elements/wavelet-erp/applets/internal-purchase-invoice-applet/ s3://akaun-applets/bigledger/wavelet-erp/internal-purchase-invoice-applet/prod --profile akaun --acl public-read --recursive
