...
# WARNING: Upload the new  file to s3
 aws s3 cp elements/wavelet-erp/applets/stock-adjustment-applet/ s3://senheng-applets/bigledger/wavelet-erp/stock-adjustment-applet/staging --profile senheng-staging --acl public-read --recursive
